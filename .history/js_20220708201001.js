...
function numberClicked(number) {
    switch(number.innerHTML) {
        ...
        case 'x':
            ...
            cashed_number = parseFloat(commaToDot(result_inner));
            operator = '*';
            isNumberNew = true;
        break;
        ...
        // RESULT
        case '=':
            result_inner.innerHTML = commaToDot(count(result_inner));
        break;
        ...
        case ',':
            ...
            commaCount = limitCommas(result_inner);
...
function count(result) {
    let temporaryNumber;
    temporaryNumber = parseFloat(commaToDot('transform', result));

    switch(operator) {
        case '*':
            return cashed_number*temporaryNumber;
        break;
    }
}
// arg 1: 'limit' = limit comma, 'transform' = transform commas to dots, arg2: string
function limitCommas(string) {
