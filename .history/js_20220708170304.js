...
const result__inner = Class('Calc__result__inner');
...
function numberClicked(number) {
    ...
    if(number.innerHTML === 'x') {
        ...
        if(result__inner.innerHTML === '0') {
            result__inner.innerHTML = number.innerHTML;
        } else {
            const OLDresult = result__inner.innerHTML;
            result__inner.innerHTML = OLDresult + number.innerHTML;
        }
    }
